    ...
    <div class="flex flex-col lg:flex-row gap-8 p-4 lg:p-8 bg-slate-50">
        <div class="flex-1 space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-black text-slate-800 uppercase tracking-tight">Historique des Télétravails
                    </h2>
        ...
        <div class="w-full lg:w-96 space-y-6">
            <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm">
                ...
                <form @submit.prevent="createTelework" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">Lieu
                            (optionnel)</label>
